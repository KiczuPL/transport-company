...
public class DataLoader {
    ...
    public void loadOrders() {
        ...
        orderService.saveOrder(new CreateOrderForm("9 Park Meadow Point", "3 Ridgeview Terrace", 0L, LocalDate.parse("2022-10-21"), VehicleType.SEMI_TRUCK));
        ...
        orderService.saveOrder(new CreateOrderForm("1123 Fair Oaks Park", "29280 Continental Circle", 1L, LocalDate.parse("2022-08-18"), VehicleType.SEMI_TRUCK));
        ...
        orderService.saveOrder(new CreateOrderForm("1 Birchwood Crossing", "6 Sutherland Junction", 1L, LocalDate.parse("2022-02-01"), VehicleType.SEMI_TRUCK));
        orderService.saveOrder(new CreateOrderForm("27 Maple Lane", "4210 Scott Crossing", 0L, LocalDate.parse("2022-02-07"), VehicleType.SEMI_TRUCK));
        orderService.saveOrder(new CreateOrderForm("1 Walton Circle", "34 Forest Avenue", 0L, LocalDate.parse("2021-11-18"), VehicleType.SEMI_TRUCK));
        ...
        orderService.saveOrder(new CreateOrderForm("55 Prairie Rose Drive", "0 Gina Hill", 0L, LocalDate.parse("2021-12-12"), VehicleType.SEMI_TRUCK));
        orderService.saveOrder(new CreateOrderForm("758 Kipling Avenue", "65243 Ridgeview Way", 1L, LocalDate.parse("2022-02-06"), VehicleType.SEMI_TRUCK));
        orderService.saveOrder(new CreateOrderForm("49131 Oak Drive", "81577 Fairview Lane", 0L, LocalDate.parse("2022-04-10"), VehicleType.SEMI_TRUCK));
        ...
        orderService.saveOrder(new CreateOrderForm("6 La Follette Junction", "88653 Oakridge Plaza", 1L, LocalDate.parse("2022-05-18"), VehicleType.SEMI_TRUCK));
        ...
        orderService.saveOrder(new CreateOrderForm("51 Fair Oaks Terrace", "8 Pankratz Hill", 1L, LocalDate.parse("2021-12-28"), VehicleType.SEMI_TRUCK));
