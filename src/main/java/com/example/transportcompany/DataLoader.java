...
public class DataLoader {
    ...
    public void loadOrders() {
        orderService.saveOrder(new CreateOrderForm("95 Anniversary Point", "05 Debra Drive", 10L, LocalDate.parse("2022-06-01"), VehicleType.SEMI_TRUCK));
        orderService.saveOrder(new CreateOrderForm("9 Park Meadow Point", "3 Ridgeview Terrace", 3L, LocalDate.parse("2022-10-21"), VehicleType.SEMI_TRUCK));
        ...
        orderService.saveOrder(new CreateOrderForm("3628 Florence Lane", "99595 Thackeray Terrace", 16L, LocalDate.parse("2022-10-18"), VehicleType.SEMI_TRUCK));
        orderService.saveOrder(new CreateOrderForm("203 Lien Drive", "042 Warrior Junction", 11L, LocalDate.parse("2022-08-08"), VehicleType.SEMI_TRUCK));
        orderService.saveOrder(new CreateOrderForm("1123 Fair Oaks Park", "29280 Continental Circle", 11L, LocalDate.parse("2022-08-18"), VehicleType.SEMI_TRUCK));
        ...
        orderService.saveOrder(new CreateOrderForm("1 Birchwood Crossing", "6 Sutherland Junction", 11L, LocalDate.parse("2022-02-01"), VehicleType.SEMI_TRUCK));
        orderService.saveOrder(new CreateOrderForm("27 Maple Lane", "4210 Scott Crossing", 3L, LocalDate.parse("2022-02-07"), VehicleType.SEMI_TRUCK));
        orderService.saveOrder(new CreateOrderForm("1 Walton Circle", "34 Forest Avenue", 3L, LocalDate.parse("2021-11-18"), VehicleType.SEMI_TRUCK));
        orderService.saveOrder(new CreateOrderForm("6 Thackeray Terrace", "9 Arapahoe Junction", 2L, LocalDate.parse("2022-06-14"), VehicleType.SEMI_TRUCK));
        orderService.saveOrder(new CreateOrderForm("10 Moose Lane", "0 Lunder Alley", 2L, LocalDate.parse("2021-12-09"), VehicleType.SEMI_TRUCK));
        orderService.saveOrder(new CreateOrderForm("55 Prairie Rose Drive", "0 Gina Hill", 3L, LocalDate.parse("2021-12-12"), VehicleType.SEMI_TRUCK));
        orderService.saveOrder(new CreateOrderForm("758 Kipling Avenue", "65243 Ridgeview Way", 11L, LocalDate.parse("2022-02-06"), VehicleType.SEMI_TRUCK));
        orderService.saveOrder(new CreateOrderForm("49131 Oak Drive", "81577 Fairview Lane", 3L, LocalDate.parse("2022-04-10"), VehicleType.SEMI_TRUCK));
        orderService.saveOrder(new CreateOrderForm("766 Dexter Plaza", "80 Golf Court", 20L, LocalDate.parse("2022-06-26"), VehicleType.SEMI_TRUCK));
        ...
        orderService.saveOrder(new CreateOrderForm("6 La Follette Junction", "88653 Oakridge Plaza", 11L, LocalDate.parse("2022-05-18"), VehicleType.SEMI_TRUCK));
        orderService.saveOrder(new CreateOrderForm("303 Waxwing Court", "69895 Oneill Plaza", 13L, LocalDate.parse("2022-01-14"), VehicleType.SEMI_TRUCK));
        ...
        orderService.saveOrder(new CreateOrderForm("888 Farmco Junction", "5216 Laurel Plaza", 2L, LocalDate.parse("2022-02-01"), VehicleType.SEMI_TRUCK));
        ...
        orderService.saveOrder(new CreateOrderForm("161 Hanson Junction", "9704 Thierer Point", 10L, LocalDate.parse("2022-02-06"), VehicleType.SEMI_TRUCK));
        ...
        orderService.saveOrder(new CreateOrderForm("72 Claremont Road", "7485 Mayfield Avenue", 16L, LocalDate.parse("2022-08-26"), VehicleType.SEMI_TRUCK));
        ...
        orderService.saveOrder(new CreateOrderForm("0 Stang Way", "3717 Portage Parkway", 19L, LocalDate.parse("2022-02-22"), VehicleType.SEMI_TRUCK));
        orderService.saveOrder(new CreateOrderForm("6996 Moulton Plaza", "5445 West Center", 20L, LocalDate.parse("2022-03-15"), VehicleType.SEMI_TRUCK));
        orderService.saveOrder(new CreateOrderForm("51 Fair Oaks Terrace", "8 Pankratz Hill", 11L, LocalDate.parse("2021-12-28"), VehicleType.SEMI_TRUCK));
        orderService.saveOrder(new CreateOrderForm("0644 Badeau Way", "5653 Farmco Terrace", 2L, LocalDate.parse("2022-01-24"), VehicleType.SEMI_TRUCK));
        orderService.saveOrder(new CreateOrderForm("3 Crownhardt Road", "5773 Hanover Way", 3L, LocalDate.parse("2022-11-01"), VehicleType.SEMI_TRUCK));
        orderService.saveOrder(new CreateOrderForm("3017 Bunker Hill Way", "87 Morningstar Street", 4L, LocalDate.parse("2022-06-07"), VehicleType.SEMI_TRUCK));
    }
